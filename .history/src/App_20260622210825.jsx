...
import AIGuideAssistant from './components/Base/AIGuideAssistant';
...
function App() {
  ...
  // Extract section background video from projects data
  const sectionBgVideo = projects?.sectionBackgroundVideo || null;
  ...
  return (
    <>
      ...
      <main className="bg-[#0B0F19] text-white">
        ...
        <Projects projects={projectList} sectionBgVideo={sectionBgVideo} />
