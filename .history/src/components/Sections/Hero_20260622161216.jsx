...
const Hero = ({ profile }) => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#0B0F19]/95 via-[#0B0F19]/80 to-[#0B0F19]/95"></div>
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-gray-200 text-base mt-4 max-w-lg">
              {profile.summary}
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="flex gap-6 mt-8 text-sm text-gray-300">
