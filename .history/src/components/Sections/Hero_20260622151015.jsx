...
const Hero = ({ profile }) => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center relative overflow-hidden">
      ...
      {/* Background Orbs */}
      <div className="absolute top-20 right-10 w-72 h-72 bg-accent/10 rounded-full blur-3xl pointer-events-none animate-pulse"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative w-80 h-80">
              <div className="absolute inset-0 bg-gradient-to-br from-accent/30 to-emerald-400/30 rounded-full blur-2xl animate-pulse"></div>
